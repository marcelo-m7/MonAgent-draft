...
from Repositories.consts import ChatConsts as c
from Assistant.responses import Responses


class KobuAssistant(Responses):
    """
        ...
        while True:
            match cv.current_conversation_stage:
                ...
                case c.FREE_CONVERSATION_STAGE:   # Stop doing verifications
                    cv = await self.free_conversation_stage(cv)
