...
class WebScraper:
    ...
    def save_to_json(self, data: dict, url: str) -> None:
        ...
        folder_name = parsed_url.path.split('/')[1]  # Get the second part of the path
        ...
        file_name = parsed_url.path.strip('/').replace('/', '_') + '.json'
...
def start_web_scraper(base_url='https://www.klarisana.com/',
                      sitemap_url='https://www.klarisana.com/testimonial_category-sitemap.xml',
                      save_folder='Tools/klarisana_web_scraper_files') -> None:
    """
